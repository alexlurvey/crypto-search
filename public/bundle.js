(function (global, factory) {
  ...
  */
  ...
  var getAllCryptos = function getAllCryptos() {
    return fetch("".concat(base_url, "/cryptocurrencies")).then(function (res) {
      return res.json();
    }).then(function (data) {
      return {
        error: false,
  ...
  var CRYPTOCURRENCIES_STORAGE_KEY = 'cryptocurrencies';

  var domain_model = 'CRYPTOCURRENCIES';
  var ACTIONS = {
    GET: "GET_".concat(domain_model),
    SET: "SET_".concat(domain_model),
    ERROR: "ERROR_".concat(domain_model)
  };
  var initialState = {
    loading: false,
    data: []
  ...
  var actionCreators = {
    getCryptocurrencies: function getCryptocurrencies() {
      return (
        ...
        function () {
          ...
          /*#__PURE__*/
          regenerator.mark(function _callee(dispatch) {
            var cryptos;
    ...
    setCryptocurrencies: function setCryptocurrencies(payload) {
      return {
        type: ACTIONS.SET,
        payload: payload
      };
    },
    errorCryptocurrencies: function errorCryptocurrencies() {
      return {
        type: ACTIONS.ERROR
      };
    }
  };
  var cryptocurrencies = function cryptocurrencies() {
  ...
  var selectCryptoData = function selectCryptoData(state) {
    return state.cryptocurrencies.data;
  };
  ...
  var selectOrderByMarketCap = function selectOrderByMarketCap(state) {
    return state.filters.orderByMarketCap;
  };

  var filteredCryptocurrencies = createSelector([selectCryptoData, selectSearch], function (data, search) {
    if (search === '') return data;
    return data.filter(function (q) {
      return q.name.toLowerCase().indexOf(search.toLowerCase()) >= 0;
    });
  });
  var sortedCryptocurrencies = createSelector([filteredCryptocurrencies, selectOrderByMarketCap], function (data, orderByMarketCap) {
    ...
    var marketCap = function marketCap(a, b) {
  ...
  var actionCreators$1 = {
    setSearch: function setSearch(payload) {
      return {
        type: ACTIONS$1.SET_SEARCH,
        payload: payload
      };
    },
    toggleOrderByMarketCap: function toggleOrderByMarketCap() {
      return {
        type: ACTIONS$1.TOGGLE_ORDER_BY_MARKET_CAP
      };
    }
  };
  var filters = function filters() {
    ...
    switch (action.type) {
      case ACTIONS$1.SET_SEARCH:
        return objectSpread({}, state, {
          search: action.payload
        });

      case ACTIONS$1.TOGGLE_ORDER_BY_MARKET_CAP:
        return objectSpread({}, state, {
  ...
  var cryptocurrencyStorage = function cryptocurrencyStorage(_store) {
    return function (next) {
      return function (action) {
  ...
  var middlewares = [thunk, cryptocurrencyStorage];
  ...
  var CryptoCard = function CryptoCard(_ref) {
    ...
    return React__default.createElement("div", {
      className: "card crypto-card-wrapper"
    }, React__default.createElement("header", {
      className: "card-header"
    }, React__default.createElement("p", {
      className: "card-header-title"
    }, crypto.name), React__default.createElement("a", {
      className: "crypto-icon-link",
      href: "https://coinmarketcap.com/currencies/".concat(crypto.slug),
      target: "_blank"
    }, React__default.createElement("span", {
      className: "icon"
    }, React__default.createElement("img", {
      src: "https://s2.coinmarketcap.com/static/img/coins/64x64/".concat(crypto.id, ".png")
    })))), React__default.createElement("div", {
      className: "card-content"
    }, React__default.createElement("div", {
      className: "content"
    }, React__default.createElement("div", null, crypto.quote.USD.price))));
  };
  ...
  var Filters = function Filters(props) {
    ...
    return React__default.createElement("div", {
      ...
      value: props.orderByMarketCap,
      onClick: props.toggleOrderByMarketCap
    }), "Order by Marketcap")));
  };
  ...
  var AppBase = function AppBase(props) {
    ...
    return React__default.createElement("section", {
      className: "section app-wrapper"
    }, React__default.createElement("div", {
      className: "container"
    }, React__default.createElement("h1", {
      className: "title"
    }, "Search Top Cryptocurrencies"), React__default.createElement(Filters, {
      search: props.search,
      onSearchChange: props.setSearch,
      orderByMarketCap: props.orderByMarketCap,
      toggleOrderByMarketCap: props.toggleOrderByMarketCap
    }), props.isLoading ? React__default.createElement("div", {
      className: "spinner ".concat(props.isLoading ? '' : 'fade-out')
    }, React__default.createElement("div", {
      ...
      return React__default.createElement(CryptoCard, {
        key: item.id,
        crypto: item
      });
    }))));
  ...
  var mapDispatch = function mapDispatch(dispatch) {
    return {
      getCryptocurrencies: function getCryptocurrencies() {
        return dispatch(actionCreators.getCryptocurrencies());
      },
      setSearch: function setSearch(payload) {
        return dispatch(actionCreators$1.setSearch(payload));
      },
      toggleOrderByMarketCap: function toggleOrderByMarketCap() {
        return dispatch(actionCreators$1.toggleOrderByMarketCap());
      }
    };
  };

  var App = connect(mapState, mapDispatch)(AppBase);
  var App$1 = (function () {
  ...
  ReactDOM__default.render(React__default.createElement(App$1, null), document.getElementById('root'));
